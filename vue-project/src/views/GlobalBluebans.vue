...
const Global_Blue_Ban_Store = useGlobalBluebanStore();
</script>

<template>
    <div class="BlueGlobalBan-container">
        <div
            v-for="(game, index) in Global_Blue_Ban_Store.GlobalBlueban"
            :key="index"
            class="BlueGlobalBan"
        >
            ...
            <div class="ban-container">
                <div v-for="(ban, i) in game" :key="i" class="globalbannd">
                    <img
                        :src="
                            ban
                                ? `https://ddragon.leagueoflegends.com/cdn/${Version_Store.version}/img/champion/${ban}.png`
                                : default_img
                        "
                        class="bans"
                        alt=""
                    />
                    <img
                        src="@/assets/data/banned_overlay_90.png"
